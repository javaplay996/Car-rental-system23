...
MySQL - 5.7.32-log : Database - qichezulin
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`qichezulin` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `cheliang`(`id`,`name`,`brand`,`design`,`img_photo`,`money`,`age`,`zt_types`,`miaoshu_content`) values (1,'11111','品牌1','款式1','http://localhost:8080/qichezulin/file/download?fileName=1619501435075.jpg',10,1,2,'<img src=\"http://localhost:8080/qichezulin/upload/1619501435075.jpg\" width=\"900\" height=\"560\" _src=\"http://localhost:8080/qichezulin/upload/1619501435075.jpg\">\r\n'),(2,'22222','品牌2','款式2','http://localhost:8080/qichezulin/file/download?fileName=1619501428977.jpg',20,2,2,'<img src=\"http://localhost:8080/qichezulin/upload/1619501428979.jpg\" width=\"900\" height=\"560\" _src=\"http://localhost:8080/qichezulin/upload/1619501428979.jpg\">\r\n'),(3,'33333','品牌3','款式3','http://localhost:8080/qichezulin/file/download?fileName=1619501423347.jpg',30,3,2,'<img src=\"http://localhost:8080/qichezulin/upload/1619501423348.jpg\" width=\"900\" height=\"560\" _src=\"http://localhost:8080/qichezulin/upload/1619501423348.jpg\">\r\n'),(4,'44444','品牌4','款式4','http://localhost:8080/qichezulin/file/download?fileName=1619501412218.jpg',40,4,2,'<img src=\"http://localhost:8080/qichezulin/upload/1619501412218.jpg\" width=\"900\" height=\"560\" _src=\"http://localhost:8080/qichezulin/upload/1619501412218.jpg\">\r\n');
...
insert  into `config`(`id`,`name`,`value`) values (1,'picture1','http://localhost:8080/qichezulin/upload/1616224935590.jpg'),(2,'picture2','http://localhost:8080/qichezulin/upload/1616224941165.jpg'),(3,'picture3','http://localhost:8080/qichezulin/upload/1616224946304.jpg'),(4,'picture4','http://localhost:8080/qichezulin/upload/1616224951408.jpg');
...
insert  into `hetong`(`id`,`name`,`wenjian_file`,`yh_types`,`qianding_time`,`pledge`) values (1,'合同名称1','http://localhost:8080/qichezulin/file/download?fileName=1616226909516.doc',2,'2021-03-20 15:55:10',1000),(2,'合同名称2','http://localhost:8080/qichezulin/file/download?fileName=1616226926799.xls',2,'2021-03-20 15:55:28',1000);
...
insert  into `news`(`id`,`addtime`,`title`,`picture`,`content`) values (1,'2020-12-24 11:36:16','标题1','http://localhost:8080/qichezulin/upload/1616224909238.jpg','内容1\r\n'),(2,'2020-12-24 11:36:16','标题2','http://localhost:8080/qichezulin/upload/1616224914991.jpg','内容2\r\n'),(3,'2020-12-24 11:36:16','标题3','http://localhost:8080/qichezulin/upload/1616224919193.jpg','内容3\r\n'),(4,'2020-12-24 11:36:16','标题4','http://localhost:8080/qichezulin/upload/1616224923464.jpg','内容4\r\n');
...
insert  into `yonghu`(`id`,`name`,`username`,`password`,`img_photo`,`sex_types`,`phone`,`money`,`role`) values (1,'小金','111','123456','http://localhost:8080/qichezulin/file/download?fileName=1619501275940.jpg',1,'17796312333',9878903,'用户'),(2,'小札','222','123456','http://localhost:8080/qichezulin/file/download?fileName=1619501281672.jpg',2,'12312312333',0,'用户');
...
CREATE TABLE `zulin` (
  ...
  `zhulin_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='租赁模块';

/*Data for the table `zulin` */

insert  into `zulin`(`id`,`cl_types`,`yh_types`,`day`,`sf_types`,`maxmoney`,`pledge`,`zhuangtai`,`zhulin_time`) values (13,3,1,123,2,3690,0,1,'2021-04-27 13:47:34'),(15,1,1,100,2,1000,400,1,'2021-04-27 14:11:08');
